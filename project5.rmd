...
```{r}
#Q4
week2 <- c(1:length(excess_death_from_2020))
cum_excess <- cumsum(excess_death_from_2020)
plot(week2, cum_excess, type = "b", pch = 18, col = "red", xlab = "weeks", ylab = "excess death")
```
...
jags_data <- list(x = excess_death_from_2020, 
...
traceplot(rho_list)
hist(unlist(rho_list), main = 'rho', xlab = "rho")
```
...
plot(weeks, unlist(p_vector[50,]), type = "l", col = "grey", 
     xlab = "Week", ylab = "Excess deaths", main = "Plot")

index <- seq(100,10000,50)
for(i in index){
  lines(weeks, unlist(p_vector[i,]), type="l", col = "grey")
}

lines(weeks, mu_coda, type="l", col = "blue")

points(weeks, excess_death_from_2020, pch = 20)

points(weeks[delete], (death_from_2020 - p_death_from_2020)[delete], pch = 20, col ="red" )
```
